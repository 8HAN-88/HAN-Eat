...
class FlexFeatureWrite(BaseModel):
    ...
    icon: Optional[str] = None
    price_rub: Optional[float] = None
    min_level: Optional[int] = Field(default=None, ge=1, le=20)
    max_level: Optional[int] = Field(default=None, ge=1, le=20)
    default_level: Optional[int] = Field(default=None, ge=1, le=20)
