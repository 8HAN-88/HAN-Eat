...
const _knownEnglishDetails = <String, String>{
  ...
  'Yandex account has no email': 'В аккаунте Яндекса нет почты',
  'В аккаунте Яндекса нет email': 'В аккаунте Яндекса нет почты',
  'В токене Google нет email': 'В аккаунте Google нет почты',
  'Это уже ваш текущий email': 'Это уже ваша текущая почта',
  'Укажите email': 'Укажите почту',
  'Бот с таким username уже существует': 'Бот с таким именем уже есть',
