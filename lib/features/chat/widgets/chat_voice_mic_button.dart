...
class _ChatVoiceMicButtonState extends State<ChatVoiceMicButton> {
  ...
  void _endPress() {
    if (!_pressing && _origin == null) return;
    _origin = null;
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
      ...
      onPointerDown: holdEnabled
          ...
          : null,
      onPointerMove: holdEnabled && _origin != null
          ? (event) {
              widget.onHoldDrag?.call(
                event.localPosition.dx - _origin!.dx,
                event.localPosition.dy - _origin!.dy,
              );
            }
          : null,
      onPointerUp: holdEnabled ? (_) => _endPress() : null,
      onPointerCancel: holdEnabled ? (_) => _endPress() : null,
