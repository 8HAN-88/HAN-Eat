...
class FeedLoadHelper {
  ...
  static String cacheBannerMessage(Object e) {
    if (e == 'offline') {
      return 'Нет интернета. Показаны сохранённые посты';
    }
    if (isSessionError(e)) {
      return 'Войдите снова — пока показаны сохранённые посты';
    }
    return 'Не удалось обновить ленту. Показаны сохранённые посты';
  }
